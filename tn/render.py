...
<head>
  <meta charset="UTF-8">
  <title>TN GIG LIST - {short_label}</title>
  {FAVICON_TAG}
  <style>{PAGE_STYLE}</style>
</head>
<body>
  <h1><a href="index.html">Nashville Gig List</a></h1>
...
<body>
  <h1>Nashville Gig List</h1>
  <p class="subtitle">Updated: {updated} &mdash; {len(upcoming)} upcoming shows across Nashville</p>
  <nav>
...
<head>
  <meta charset="UTF-8">
  <title>NASHVILLE GIG LIST</title>
  {FAVICON_TAG}
  <style>{PAGE_STYLE}</style>
</head>
<body>
...
<head>
  <meta charset="UTF-8">
  <title>TN GIG LIST - PAST</title>
  {FAVICON_TAG}
  <style>{PAGE_STYLE}</style>
</head>
<body>
  <h1><a href="index.html">Nashville Gig List</a> — Past Shows</h1>
